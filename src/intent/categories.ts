...
const HINTS: Array<[EventCategory, RegExp]> = [
  ...
  [
    'SCHOOL',
    /โรงเรียน|รร\.|ครู|สอบ|ผู้ปกครอง|เปิดเทอม|ปิดเทอม|ภาคเรียน|คะแนน|การบ้าน|ลูกเสือ|เนตรนารี|ยุวกาชาด|กีฬาสี|ทัศนศึกษา|ปฐมนิเทศ|อ่านหนังสือ|เรียนพิเศษ|ติว|คอร์ส|course|รับปริญญา|มหาลัย|กิจกรรมโรงเรียน/i,
  ],
